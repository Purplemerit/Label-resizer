            ...
            {integrations.map((integration) => {
              ...
              >
                ...
                <Button
                  ...
                  disabled={loading}
                  className={
                    isConnected ? "bg-transparent" : "bg-accent text-accent-foreground hover:bg-accent/90"
                  }
                >
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 rounded-lg border border-border bg-muted/30">
              <div>
                ...
                <p className="text-sm text-muted-foreground font-mono">{maskApiKey(apiKeys.prod)}</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 rounded-lg border border-border bg-muted/30">
              <div>
                ...
                <p className="text-sm text-muted-foreground font-mono">{maskApiKey(apiKeys.test)}</p>
              </div>
              <div className="flex gap-2">
                <Button 
                  variant="outline" 
